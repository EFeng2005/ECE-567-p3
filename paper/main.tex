...
percentiles of $\hat{V} - G$ (Table~\ref{tab:percentile_bias}) show the
real signal.
...
What matters for Eq.~\eqref{eq:subgoal_select} is not bias magnitude but
whether $\hat{V}$ \emph{ranks} states correctly
